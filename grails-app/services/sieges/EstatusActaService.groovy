...
/**
	...
	def listar(params){
		...
		def estatus = EstatusActa.createCriteria().list(params,criteria)
	...
	def obtenerActivos(params){
		...
		def estatus = EstatusActa.createCriteria().list {
			eq("activo", true)
		}
	...
	def consultar(params) {
		...
		def estatus = EstatusActa.get(params.id)
