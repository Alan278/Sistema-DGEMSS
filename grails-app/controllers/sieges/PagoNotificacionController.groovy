...
/**
    ...
    def registro(){
        def resultado = pagoService.consultarPago(params, tipoTramiteService.NOTIFICACION)
        if(!flash.mensaje){
    ...
    def seleccionNotificaciones(){

        def institucion = Institucion.get(params.institucionId)
        def notificaciones = notificacionService.listarNotificacionesSinTramite(params).datos
    ...
    def registrar(){
        def resultado = pagoNotificacionService.registrar(params)
        flash.estatus = resultado.estatus
        flash.mensaje = resultado.mensaje
    ...
    def listar(){
        def resultado = pagoNotificacionService.listar(params)
        def instituciones = institucionService.obtenerActivos(params)
    ...
    def obtenerActivos(){
        def tramites = pagoNotificacionService.obtenerActivos(params)
    ...
    def consultar(){
        def resultado = pagoNotificacionService.consultar(params)
        flash.estatus = resultado.estatus
        flash.mensaje = resultado.mensaje
     ...
     */
    def modificar(){
        def resultado = pagoNotificacionService.modificar(params)
        flash.estatus = resultado.estatus
        flash.mensaje = resultado.mensaje
    ...
    def eliminar(){
        def resultado = pagoNotificacionService.eliminar(params)
        flash.estatus = resultado.estatus
        flash.mensaje = resultado.mensaje
