...
class PagoConstanciaController {

    def pagoConstanciaService
    /**
    ...
    def registro(){
        def resultado = pagoService.consultarPago(params, tipoTramiteService.CONSTANCIA)
        if(!flash.mensaje){
    ...
    def seleccionConstancias(){

        def institucion = Institucion.get(params.institucionId)
        def constancias = constanciaService.listarConstanciasSinTramite(params).datos
    ...
    def registrar(){
        def resultado = pagoConstanciaService.registrar(params)
        flash.estatus = resultado.estatus
        flash.mensaje = resultado.mensaje
    ...
    def listar(){
        def resultado = pagoConstanciaService.listar(params)
        def instituciones = institucionService.obtenerActivos(params)
    ...
    def obtenerActivos(){
        def tramites = pagoConstanciaService.obtenerActivos(params)
    ...
    def consultar(){
        def resultado = pagoConstanciaService.consultar(params)
        flash.estatus = resultado.estatus
        flash.mensaje = resultado.mensaje
     ...
     */
    def modificar(){
        def resultado = pagoConstanciaService.modificar(params)
        flash.estatus = resultado.estatus
        flash.mensaje = resultado.mensaje
    ...
    def eliminar(){
        def resultado = pagoConstanciaService.eliminar(params)
        flash.estatus = resultado.estatus
        flash.mensaje = resultado.mensaje
