...
class PagoActaController {
    ...
    def registro(){
        def resultado = pagoService.consultarPago(params, tipoTramiteService.ACTA)
        if(!flash.mensaje){
    ...
    def seleccionActas(){
        ...
        def actas = actaService.listarActasSinTramite(params).datos
    ...
    def registrar(){
        def resultado = pagoActaService.registrar(params)
        flash.estatus = resultado.estatus
        flash.mensaje = resultado.mensaje
    ...
    def listar(){
        def resultado = pagoActaService.listar(params)
        def instituciones = institucionService.obtenerActivos(params)
    ...
    def obtenerActivos(){
        def tramites = pagoActaService.obtenerActivos(params)
    ...
    def consultar(){
        def resultado = pagoActaService.consultar(params)
        flash.estatus = resultado.estatus
        flash.mensaje = resultado.mensaje
