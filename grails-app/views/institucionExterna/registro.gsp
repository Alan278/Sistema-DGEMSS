...
<head>
    ...
    <title>Nuevas Instituciones Foráneas / Externas</title>
</head>
...
<body>
    ...
    <div class="row mb-5">
        <div class="col-md-12 pt-2 border-bottom">
            <h3 class="page-title pl-3">
                Nueva Institución Foránea / Externa
            </h3>
        </div>
    </div>
    <div class="container">
    ...
    <div class="container mb-5">
        <form action="/institucionExterna/registrar" class="needs-validation" novalidate>
