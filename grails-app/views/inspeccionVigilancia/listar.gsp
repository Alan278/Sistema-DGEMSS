...
<html>
    ...
    <body>
        ...
        <div class="container">
            <form action="/inspeccionVigilancia/listar" class="mt-4" id="form-busqueda">
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-md-6">
                        <div class="input-group mb-3">
                            <input type="text" class="form-control" id="search" name="search" value="${params?.search}" placeholder="Folio / No. trámite">
                            <div class="input-group-prepend">
                    ...
                    <g:each status="i" in="${tramites}" var="tramite">
                            <tr>
                                <td class="align-middle">
                                    <a onclick="mostrarProceso();" href="/inspeccionVigilancia/consultar/${tramite?.id}" data-tooltip="tooltip" data-placement="top" title="Consultar tramite" class="alert-link" >
                                ...
                                <!-- <td class="align-middle" align="end">
                                    ...
                                    <button type="button" class="btn btn-outline-danger btn-sm" data-id="${tramite?.id}" data-toggle="modal" data-target="#modalEliminacion_${tramite?.pago?.id}" data-tooltip="tooltip" data-placement="top" title="Eliminar tramite">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a onclick="mostrarProceso();"  href="/inspeccionVigilancia/eliminar/${tramite?.id}" class="btn btn-primary">Aceptar</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
