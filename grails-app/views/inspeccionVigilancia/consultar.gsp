    ...
    <body>
        ...
        <div class="container">
            ...
            <table id="table" class="table">
                ...
                <tBody>
                    <g:each status="i" in="${tramite?.ciclosEscolares}" var="cicloEscolar">
                            <tr>
                                <td>${i+1}</td>
                                <td>${cicloEscolar?.nombre}</td>
                                <td>${cicloEscolar?.periodo}</td>
                                <td>${cicloEscolar?.inicio}</td>
                                <td>${cicloEscolar?.fin}</td>
                                <td>${cicloEscolar?.planEstudios?.carrera?.nombre}</td>
                                <td>${cicloEscolar?.planEstudios?.nombre}</td>
                            </tr>
                    </g:each>
                </tBody>
            </table>
              ...
              <div class="d-flex justify-content-end mb-5">
                <p>
                    ...
                    <a onclick="mostrarProceso();" href="certificacion/modificacion/${tramite?.id}" class="btn btn-outline-primary">
                        Modificar
                    </a> -->
