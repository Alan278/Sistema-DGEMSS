        ...
        <div class="row mb-4">
            <div class="col-md-12 pt-2 border-bottom">
                <h3 class="page-title pl-3">
                    Nuevo Trámite / Inspección y vigilancia
                </h3>
            </div>
        </div>
        ...
        <div class="container mb-5">
            ...
            <div class="tab-content mt-4" id="myTabContent">
                <div class="tab-pane fade ${!params.serie ? 'show active' : ''}" id="line-captura" role="tabpanel" aria-labelledby="home-tab">
                    <form id="lineCapturaForm" action="/inspeccionVigilancia/registro" class="needs-validation" method="post" novalidate>
                        <div class="form-row">
                ...
                <div class="tab-pane fade ${params.serie ? 'show active' : ''}" id="folio" role="tabpanel" aria-labelledby="profile-tab">
                    <form id="folioForm" action="/inspeccionVigilancia/registro" class="needs-validation" method="post" novalidate>
                        <div class="form-row">
                            <div class="form-group col-md-5">
            ...
            <form action="/inspeccionVigilancia/seleccionCiclosEscolares" class="needs-validation" novalidate>
