    ...
    <body>
                ...
                <div class="col-md-6">
                    <div class="card h-100">
                        <div class="card-body  ">
                            ...
                            <div class="mb-1">
                                <h6 class="d-inline">
                                    <b>Total certificados: </b>${certificados.totalCount}
                                </h6>
                            </div>
                            <div class="mb-1">
                                <h6 class="d-inline">
                                    <b>Certificados pagados: </b><span id="nPagados"></span>
                                </h6>
                            </div>
                            <div class="mb-1">
                                <h6 class="d-inline">
        ...
        <div class="container">
            ...
            <table id="table" class="table">
                ...
                <tBody>
                    <g:each status="i" in="${certificados}" var="certificado">
                            ...
                            <g:each status="j" in="${certificado.alumno.ciclosEscolares}" var="ciclo">
                                <g:if test="${ciclo.activo}">
                            ...
                            <tr id="tr${certificado.id}">
                                ...
                                <td>${certificado?.alumno?.planEstudios?.carrera?.nombre}</td>
                                <td>
            ...
            <div class="form-row justify-content-end my-5">
                <a onclick="mostrarProceso();" href="certificacion/listar" class="btn btn-secondary">Cancelar</a>
                <a onclick="mostrarProceso();" href="certificacion/registro" class="btn btn-secondary ml-1">Volver</a>
                <form id="form" action="/certificacion/registrar" class=" ml-1">
                    ...
                    <input id="certificados" name="certificados" type="text" hidden >
        ...
        <script>
            ...
            $('#btnGuardar').on('click', function() {
                if(certificadosId.length > nPagados){
                    alert("Seleccione " + nPagados + " certificados");
                    return
                }
                mostrarProceso()
                $('#form').submit();
            ...
            function seleccionar(id){
                ...
                $("#nSeleccionados").html(certificadosId.length)
