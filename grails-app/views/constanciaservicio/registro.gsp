...
<html>
    ...
    <body>
        ...
        <div class="container mb-5">
            <form action="/constanciaservicio/aceptar" class="needs-validation" novalidate>
                    <input id="uuid" name="uuid" type="text" value="${constancia?.uuid}" hidden>
                    <div class="form-row">
                <div class="form-row justify-content-end">
                    <p>
                        <a onclick="mostrarProceso();" href="constanciaservicio/revision?uuid=${constancia?.uuid}" class="btn btn-secondary">Cancelar</a>
