...
<html>
    ...
    <body>
        ...
        <g:render template="/layouts/pagination" model="${[linkUri: "constanciaservicio/listarFirmasConstancias", linkParams: [search: params.search?:"", institucionId: params.institucionId?:""], count: conteo, max: params.max, offset: params.offset]}"/>
