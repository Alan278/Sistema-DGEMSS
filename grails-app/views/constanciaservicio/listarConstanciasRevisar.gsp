...
<html>
    ...
    <body>
        ...
        <div class="container">
            <form id="form-busqueda" action="/constanciaservicio/listarConstanciasRevisar" class="mt-4">
                        ...
                        <tBody>
                            <g:each status="i" in="${constancias}" var="constancia">
                                    <tr>
                                        ...
                                        <td class="align-middle">${constancia?.alumno?.matricula}</td>
                                        <td class="align-middle">${constancia?.alumno?.persona.nombre} ${constancia?.alumno?.persona.primerApellido} ${constancia?.alumno?.persona.segundoApellido}</td>
                                        <td class="align-middle">
                                            ${constancia?.firmaAutenticadorDgemss?.fechaFirma}
                                        </td>
                                        <td class="align-middle">
                                            ${constancia?.estatusConstancia?.nombre}
                                        </td>
                                        <td class="text-right">
                                            <a onclick="mostrarProceso();" href="/constanciaservicio/revision?uuid=${constancia.uuid}" class="btn btn-outline-primary btn-sm" data-tooltip="tooltip" data-placement="top" title="Validar">
