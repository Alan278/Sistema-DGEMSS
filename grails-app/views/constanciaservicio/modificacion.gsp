                ...
                <div class="col-md-6">
                    <div class="card" >
                        ...
                        <div class="card-body py-2 px-3">
                            <div class="card-text">
                                <p class="m-0"> <b> Institución: </b>${certificado.persona?.alumnos[0]?.cicloEscolar?.carrera?.institucion?.nombre} </p>
                                <p class="m-0"> <b> Carrera: </b> ${certificado.persona?.alumnos[0]?.cicloEscolar?.carrera?.nombre}</p>
