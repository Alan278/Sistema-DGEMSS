...
<html>
    ...
    <body>
        ...
        <div class="container mb-5">
            ...
            <g:else>
                <form id="formu" action="/constanciaservicio/firmarConstancias" enctype="multipart/form-data" method="POST" class="needs-validation" novalidate>
                    ...
                    <input type="text" name="constancias" value="${params.constancias}" hidden>
                    ...
                    <div class="form-row justify-content-end">
                        <p>
                            <a onclick="mostrarProceso();" href="constanciaservicio/listarConstanciasInstitucion/${params.institucionId}" class="btn btn-secondary">Cancelar</a>
