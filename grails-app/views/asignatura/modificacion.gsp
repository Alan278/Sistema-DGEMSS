...
<html>
    <head>
        ...
        <title>Modificación de Asignatura</title>
    ...
    <body>
        ...
        <div class="container" >
            <form action="/asignatura/modificacion/${asignatura?.id}" id="form-select" method="post">
        ...
        <div class="container mb-5">
            <form action="/asignatura/modificar/${asignatura?.id}" class="needs-validation" novalidate>
                <div class="form-group">
                    <label for="institucionesMod">Institucion<font color="red">*</font></label>
                    <g:select  class="form-control" id="institucionesMod" name="institucionesMod" from="${instituciones}" optionKey="id" optionValue='${{"CCT: ${it.claveCt ?: ""} :::: NOMBRE: ${it.nombre}"}}' value="${asignatura?.planEstudios?.carrera?.institucion?.id}" required="true"/>
                ...
                <div class="form-group">
                    <label for="creditos">Número de créditos <font color="red">*</font></label>
                ...
                <div class="form-group">
                    ...
                    <g:select class="form-control" id="formacionId" name="formacionId" from="${formaciones}" optionKey="id" optionValue="nombre" value="${asignatura?.formacion?.id}" noSelection="${['':'Seleccione...']}" required="true"/>
                    <div class="invalid-feedback">
