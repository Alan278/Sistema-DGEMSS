...
<html>
    ...
    <body>
        ...
        <div class="container">
            <form id='form-busqueda' action="/certificado/listarInstituciones" class="mt-4">
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="input-group mb-3">
                            ...
                            <g:if test="${params.search}">
                                <div class="input-group-append">
                                    <g:link uri="/certificado/listarInstituciones/" params="${[max: params.max, offset: params.offset]}" class="btn btn-outline-secondary">
                    ...
                    <tBody>
                        <g:each status="i" in="${instituciones}" var="institucion">
                            <tr>
                                ...
                                <td class="align-middle">${institucion.numCertificados}</td>
        ...
        <g:render template="/layouts/pagination" model="${[linkUri: "certificado/listarInstituciones", linkParams: [search: params.search?:"", isPublic: params.isPublic?:""], count: conteo, max: params.max, offset: params.offset]}"/>
