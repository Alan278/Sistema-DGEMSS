...
<html>
    ...
    <body>
        ...
        <div class="container mb-5">
            <form id="formulario" action="/certificado/registrar" method="POST" class="needs-validation" novalidate>

                <div class="form-group form-check mb-4 ml-1">
                    <input class="form-check-input" type="checkbox" id="duplicado" name="duplicado"
                        ${params.duplicado ? "checked" : "" }>
                    ...
                    <div class="col-md-6">
                        <div class="row mb-3">
                            ...
                            <div class="custom-file mx-3">
                                ...
                                <div class="invalid-feedback">
                                    Por favor elija la fotrografía del alumno.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-center mt-5">
                            <p>
                                ...
                                <a onclick="mostrarProceso();" href="certificado/listarAlumnos" class="btn btn-secondary" >Volver</a>
