...
<html>
    <head>
        ...
        <title>Nuevo Plan de Estudios Foráneo / Externo</title>
    ...
    <body>
        ...
        <div class="row mb-4">
            <div class="col-md-12 pt-2 border-bottom">
                <h3 class="page-title pl-3">
                    Nuevo Plan de Estudios Foráneo / Externo
                </h3>
            </div>
        </div>
        ...
        <div class="container" >
            <form action="/planEstudiosExterno/registro" id="form-select" method="post">
        ...
        <div class="container mb-5">
            <form action="/planEstudiosExterno/registrar" class="needs-validation" novalidate>
                <div class="form-group">
                    <label for="institucionesMod">Institución <font color="red">*</font></label>
                    <g:select  class="form-control" id="institucionesMod" name="institucionesMod" from="${instituciones}" optionKey="id" optionValue="nombre" value="${planEstudios?.institucionId}" required="true"/>
                ...
                <div class="form-group align-items-start">
                        ...
                        <div class="input-group col-md-4 px-0 mb-2">
                            ...
                            <input type="number" step="0.01" class="form-control" id="calificacionMinima" name="calificacionMinima" value="${planEstudios?.calificacionMinima}"onkeypress="return esCalificacion(event, this.id);">
                            <div class="invalid-feedback">
                        ...
                        <div class="input-group col-md-4 px-0 mb-2">
                            ...
                            <input type="number" step="0.01" class="form-control" id="calificacionMinimaAprobatoria" name="calificacionMinimaAprobatoria" value="${planEstudios?.calificacionMinimaAprobatoria}"onkeypress="return esCalificacion(event, this.id);">
                            <div class="invalid-feedback">
                                Por favor ingrese una calificación válida
                            </div>
                        </div>
                        <div class="input-group col-md-4 px-0">
                            ...
                            <input type="number" step="0.01" class="form-control" id="calificacionMaxima" name="calificacionMaxima" value="${planEstudios?.calificacionMaxima}"onkeypress="return esCalificacion(event, this.id);">
                            <div class="invalid-feedback">
                                Por favor ingrese una calificación válida
                            </div>
                        </div>
