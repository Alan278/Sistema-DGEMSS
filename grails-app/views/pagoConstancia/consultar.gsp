    ...
    <body>
        ...
        <div class="container">
            ...
            <table id="table" class="table">
                ...
                <tBody>
                    <g:each status="i" in="${tramite?.constancias}" var="constancia">
                            <tr id="tr${constancia.id}">
                                <td>${i+1}</td>
                                <td>${constancia?.alumno?.persona?.curp}</td>
                                <td>
                                    ${constancias?.alumno?.persona?.nombre} ${constancia?.alumno?.persona?.primerApellido} ${constancia?.alumno?.persona?.segundoApellido}
                                </td>
                                <td>${constancias?.alumno?.planEstudios?.carrera?.nombre}</td>
                            </tr>
                    </g:each>
                </tBody>
            </table>
