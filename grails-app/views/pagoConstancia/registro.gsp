...
<html>
    ...
    <body>
        ...
        <div class="container">            <div class="alert alert-light" role="alert">
        ...
        <div class="container mb-5">
            ...
            <div class="tab-content mt-4" id="myTabContent">
                <div class="tab-pane fade ${!params.serie ? 'show active' : ''}" id="line-captura" role="tabpanel" aria-labelledby="home-tab">
                    <form id="lineCapturaForm" action="/pagoConstancia/registro" class="needs-validation" method="post" novalidate>
                        <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input id="fechaPago" type="text" class="form-control" value="${params.datosPago ? params.datosPago.folio : ''}" readonly>                        <div class="invalid-feedback">
                ...
                <div class="tab-pane fade  ${params.serie ? 'show active' : ''}" id="folio" role="tabpanel" aria-labelledby="profile-tab">
                    <form id="folioForm" action="/pagoConstancia/registro" class="needs-validation" method="post" novalidate>
                        <div class="form-row">
                            <div class="form-group col-md-5">
            ...
            <form action="/pagoConstancia/seleccionConstancias" class="needs-validation" novalidate>                <input id="serie" name="serie" type="text" value="${params?.serie}" hidden>
        ...
        <script>
            ...
            $("#lineaCapturaAux").on("input", function(){                $('#lineaCaptura').val($('#lineaCapturaAux').val())
