...
<html>
    <head>
        ...
        <title>Nueva Asignatura Foránea / Externa</title>
    ...
    <body>
        ...
        <div class="row mb-4">
            <div class="col-md-12 pt-2 border-bottom">
                <h3 class="page-title pl-3">
                    Nueva Asignatura Foránea / Externa
                </h3>
            </div>
        </div>
        ...
        <div class="container" >
            <form action="/asignaturaExterna/registro" id="form-select" method="post">
        ...
        <div class="container mb-5">
            <form action="/asignaturaExterna/registrar" class="needs-validation" novalidate>
                <div class="form-group">
                    <label for="institucionesMod">Institución<font color="red">*</font></label>
                    <g:select  class="form-control" id="institucionesMod" name="institucionesMod" from="${instituciones}" optionKey="id" optionValue="nombre" value="${asignatura?.institucionId}" required="true"/>
