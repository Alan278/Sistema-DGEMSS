...
<html>
    <head>
        ...
        <title>Modificación de Plan de Estudios</title>
    ...
    <body>
        ...
        <div class="container" >
            <form action="/planEstudios/modificacion/${planEstudios?.id}" id="form-select" method="post">
        ...
        <div class="container mb-5">
            <form action="/planEstudios/modificar/${planEstudios?.id}" class="needs-validation" novalidate>
                <div class="form-group">
                    <label for="institucionesMod">Institución<font color="red">*</font></label>
                    <g:select  class="form-control" id="institucionesMod" name="institucionesMod" from="${instituciones}" optionKey="id" optionValue='${{"CCT: ${it.claveCt ?: ""} :::: NOMBRE: ${it.nombre}"}}' value="${planEstudios?.carrera?.institucion?.id}" required="true"/>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input id="fechaRvoe" name="fechaRvoe" type="date" class="form-control"  value="${planEstudios.fechaRvoeFormatoFormulario}" required>
                        <div class="invalid-feedback">
                ...
                <div class="form-group">
                    ...
                    <g:select  class="form-control" id="turnoId" name="turnoId" from="${turnos}" optionKey="id" optionValue="nombre" value="${planEstudios?.turnoId}" required="true"/>
                    <div class="invalid-feedback">
                ...
                <div class="form-group align-items-start">
                    ...
                    <div class="input-group col-md-5 px-0 mb-2">
                        ...
                        <input type="number" step="0.01" min="0" max="10" class="form-control" id="calificacionMinima" name="calificacionMinima" value="${planEstudios?.calificacionMinima}" onkeypress="return esCalificacion(event, this.id);" required>
                        <div class="invalid-feedback">
                    ...
                    <div class="input-group col-md-5 px-0 mb-2">
                        ...
                        <input type="number" step="0.01" min="0" max="10" class="form-control" id="calificacionMinimaAprobatoria" name="calificacionMinimaAprobatoria" value="${planEstudios?.calificacionMinimaAprobatoria}" onkeypress="return esCalificacion(event, this.id);" min="${calificacionMinima}" required>
                        <div class="invalid-feedback">
                    ...
                    <div class="input-group col-md-5 px-0">
                        ...
                        <input type="number" step="0.01" min="0" max="10" class="form-control" id="calificacionMaxima" name="calificacionMaxima" value="${planEstudios?.calificacionMaxima}" onkeypress="return esCalificacion(event, this.id);" min="${calificacionMinima}" required>
                        <div class="invalid-feedback">
                            La calificación debe ser mayor a la mínima
                        </div>
                    </div>
                ...
                <div>
                    <label for="ciclos">Formaciones</label>
                    <input type="text" id="listaFormaciones" name="listaFormaciones" value="${}" hidden >
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" placeholder="Formación" id="formacionId">
                        <div class="input-group-append">
                          <button class="btn btn-outline-secondary" type="button" onclick="agregarFormacion()">Agregar</button>
                        </div>
                    </div>
                    <table class="table table-sm" id="tablaFormaciones">
                        <thead>
                            <tr>
                                <th>Nombre</th>
                            </tr>
        ...
        <script>
            $("#calificacionMinima").prop("max", $("#calificacionMaxima").val());
            ...
            function cargarFormaciones(){
                if($("#listaFormaciones").val()){
                    var formacionesInput= document.getElementById("listaFormaciones")
                    if(!formacionesInput.value == ""){
                        formaciones = JSON.parse(formacionesInput.value)
                    }
                }else{
                    <g:each in="${planEstudios?.formaciones}" var="registro">
                        var formacion = {
                            "id": "${registro.id}",
                            "nombre": "${registro.nombre}",
                        }
                        formacion.nombre = formacion.nombre.replaceAll('&quot;', '"')
            ...
            function mostrarTabla(){
                ...
                var formacionesJson = JSON.stringify(formaciones);
                console.log(formacionesJson)
                var formacionesInput = document.getElementById("listaFormaciones")
                formacionesInput.value = formacionesJson

                $("#tablaFormaciones tr:gt(0)").remove()

                formaciones.forEach(function(formacion, indice) {
                    var formacion_node = document.createTextNode(formacion.nombre);

                    var td_formacion_node = document.createElement("td");
                    td_formacion_node.appendChild(formacion_node);
                    ...
                    tr_node.appendChild(td_formacion_node);
                    tr_node.appendChild(td_del_node);

                    var table_node = document.getElementById("tablaFormaciones");
            ...
            function agregarFormacion(){
                var nombre =  document.getElementById('formacionId');
