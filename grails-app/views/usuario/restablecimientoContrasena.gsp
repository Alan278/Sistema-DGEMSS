                    ...
                    <div class="card" style="height: 100%;" >
                        <div class="card-body py-3 px-3">
                            <div class="card-text">
                                ...
                                <form id="form" action="/usuario/restablecerContrasena"  method="post">

                                    <input type="text" name="token" value="${params.token}" hidden>

                                    <div class="form-group">
                                        <label for="contrasena">Nueva contraseña <font color="red">*</font></label>
                                    ...
                                    <div class="form-group">
                                        <label for="contrasena2">Vuelva a escribir la nueva contraseña <font color="red">*</font></label>
