...
<html>
     <head>
        ...
        <title>Generar notificación profesional.</title>
    ...
    <body>
        ...
        <!-- Acciones -->
        <content tag="buttons">
            <a href="/NotificacionProfesional/listarNotificaciones" class="btn btn-primary col-md-12 my-2">
                Nueva notificación
            </a>
        </content>
        ...
        <div class="row mb-4">
            <div class="col-md-12 pt-2 border-bottom">
                <h3 class="page-title pl-3">
                    Nueva notificación - Seleccion de alumno
                </h3>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <form id="form-busqueda" action="/NotificacionProfesional/listarAlumnos" class="mt-4">
                ...
                <tBody>
                    <g:each status="i" in="${alumnos}" var="alumno">
                            <tr>
                                ...
                                <td>
                                    <a onclick="mostrarProceso();" href="/NotificacionProfesional/solicitud/${alumno.id}" class="alert-link">
                                        Seleccionar
                                    </a>
                                </td>
                            </tr>
        ...
        <g:render template="/layouts/pagination" model="${[linkUri: "NotificacionProfesional/listarAlumnos", linkParams: [search: params.search?:"", institucionId: params.institucionId?:"", carreraId: params.carreraId?:"", cicloEscolarId: params.cicloEscolarId?:""], count: conteo, max: params.max, offset: params.offset]}"/>
