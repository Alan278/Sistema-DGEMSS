    ...
    <body>
        <div class="row mb-4">
            <div class="col-md-12 pt-2 border-bottom">
                <h3 class="page-title pl-3">
                    Nueva acta - Subir foto del alumno
                </h3>
            </div>
        </div>
        ...
        <div class="container mb-5">
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <form id="formulario" action="/NotificacionProfesional/registrar" method="POST" class="needs-validation" novalidate>
                        <div class="row mb-3">
                        ...
                        <div class="row justify-content-center mt-5">
                            <p>
                                <a onclick="mostrarProceso();" href="NotificacionProfesional/listarActas" class="btn btn-secondary">Cancelar</a>
                                <a onclick="mostrarProceso();" href="NotificacionProfesional/listarAlumnos" class="btn btn-secondary" >Volver</a>
