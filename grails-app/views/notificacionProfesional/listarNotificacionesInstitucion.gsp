...
<html>
    ...
    <body>
        ...
        <!-- Acciones -->
        <content tag="buttons">
            <a href="/NotificacionProfesional/firmarNotificaciones/${institucion?.id}" class="btn btn-primary col-md-12 my-2">
                Firmar todas las notificaciones
            </a>
        </content>
        ...
        <div class="container">
            ...
            <div class="d-flex justify-content-between mb-3">
                ...
                <form id="formFirmar" action="/NotificacionProfesional/firmaNotificaciones" method="post" >
                    <input type="text" name="notificaciones" id="notificaciones" hidden>
                    <input type="text" name="institucionId" id="institucionId" value="${institucion?.id}" hidden>
                    <a id="btnFirmar"  class="btn btn-primary my-2" onclick="firmaNotificaciones()">
