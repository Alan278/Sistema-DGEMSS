                                        ...
                                        <div class="row ">
                                            <div class="col-md-6">
                                                <p class="my-1"> <b> Institución: </b>${notificacion?.alumno?.planEstudios?.carrera?.institucion?.nombre} </p>
                                                    ...
                                                    <g:if test="${notificacion?.alumno?.planEstudios?.rvoe}">
                                                        <p class="my-1"> <b> No.RVOE: </b> ${notificacion?.alumno?.planEstudios?.rvoe}</p>
                                                    </g:if>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <p class="my-1"> <b> Tipo de documento: </b>${notificacion?.doc?.nombre}</p>
                        ...
                        <g:if test="${statusId != 9}">
                            <div class="card sticky-top-b mb-3">
                                <div class="card-body">
                                    ...
                                    <textarea class="form-control" id="comentarios" name="comentarios" rows="5" disabled>${notificacion?.comentarios}</textarea>
                                ...
                                <div class="col">
                                    <sec:ifAnyGranted roles='ROLE_GESTOR_ESCUELA'>
                                        <g:if test="${statusId == 1 || statusId == 3 || statusId == 6}">
                                            <a onclick="mostrarProceso();" href="/NotificacionProfesional/cambiarEstatusFirmandoEscuela?uuid=${notificacion.uuid}" class="btn btn-primary btn-sm bck">Enviar a firmar</a>
                                            <a onclick="mostrarProceso();" href="/NotificacionProfesional/subirFotoModificacion?uuid=${notificacion.uuid}" class="btn btn-secondary btn-sm bck">Modificar fotografía</a>
                                        </g:if>
                                    </sec:ifAnyGranted>

                                    <sec:ifAnyGranted roles='ROLE_AUTENTICADOR_DGEMSS'>
                                        <g:if test="${statusId == 7}">
                                            <a onclick="mostrarProceso();" href="/NotificacionProfesional/listarFirmasNotificaciones" class="btn btn-secondary btn-sm bck">Volver</a>
                                        </g:if>
                                        <g:else>
                                            <a onclick="mostrarProceso();" href="/NotificacionProfesional/listarNotificaciones" class="btn btn-secondary btn-sm bck">Volver</a>
                                        </g:else>
                                    </sec:ifAnyGranted>
