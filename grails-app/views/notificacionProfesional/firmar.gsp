...
<html>
    ...
    <body>
                    ...
                    <div class="card" >
                        ...
                        <div class="card-body py-2 px-3">
                            <div class="card-text">
                                ...
                                <p class="m-0"> <b> Alumno: </b> ${notificacion?.alumno?.persona?.nombre} ${notificacion?.alumno?.persona?.primerApellido} ${constancia?.alumno?.persona?.segundoApellido}</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <p class="m-0"> <b> Fecha de expedición: </b> ${notificacion?.firmaAutenticadorDgemss?.fechaFirmaFormato}</p>
                </div>
            </div>
        </div>
        ...
        <div class="container mb-5">
            ...
            <g:else>
                <form id="formu" action="/NotificacionProfesional/firmarNotificacion" enctype="multipart/form-data" method="POST" class="needs-validation" novalidate>
                    
                    <input type="text" name="uuid" value="${notificacion?.uuid}" hidden>
                    ...
                    <div class="form-row justify-content-end">
                        <p>
                            <a onclick="mostrarProceso();" href="certificado/listarFirmasConstancias" class="btn btn-secondary">Cancelar</a>
