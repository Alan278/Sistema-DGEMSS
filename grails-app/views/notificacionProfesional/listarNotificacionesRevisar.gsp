...
<html>
    <head>
        ...
        <title>Constancias a revisar</title>
    ...
    <body>
        ...
        <div class="container">
            <form id="form-busqueda" action="/NotificacionProfesional/listarNotificacionesRevisar" class="mt-4">
                        ...
                        <tBody>
                            <g:each status="i" in="${notificaciones}" var="notificacion">
                                    <tr>
                                        ...
                                        <td class="align-middle">${notificacion?.alumno?.matricula}</td>
                                        <td class="align-middle">${notificacion?.alumno?.persona.nombre} ${notificacion?.alumno?.persona.primerApellido} ${notificacion?.alumno?.persona.segundoApellido}</td>
                                        <td class="align-middle">
                                            ${notificacion?.firmaAutenticadorDgemss?.fechaFirma}
                                        </td>
                                        <td class="align-middle">
                                            ${notificacion?.estatusNotificacion?.nombre}
                                        </td>
                                        <td class="text-right">
                                            <a onclick="mostrarProceso();" href="/NotificacionProfesional/revision?uuid=${notificacion.uuid}" class="btn btn-outline-primary btn-sm" data-tooltip="tooltip" data-placement="top" title="Validar">
