...
<html>
     <head>
        ...
        <title>Generar acta profesional.</title>
    ...
    <body>
        ...
        <!-- Acciones -->
        <content tag="buttons">
            <a href="/actaprofesional/listarActas" class="btn btn-primary col-md-12 my-2">
                Nueva acta
            </a>
        </content>
        ...
        <div class="row mb-4">
            <div class="col-md-12 pt-2 border-bottom">
                <h3 class="page-title pl-3">
                    Nueva acta - Seleccion de alumno
                </h3>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <form id="form-busqueda" action="/actaprofesional/listarAlumnos" class="mt-4">
                ...
                <tBody>
                    <g:each status="i" in="${alumnos}" var="alumno">
                            <tr>
                                ...
                                <td>
                                    <a onclick="mostrarProceso();" href="/actaprofesional/solicitud/${alumno.id}" class="alert-link">
                                        Seleccionar
                                    </a>
                                </td>
                            </tr>
        ...
        <g:render template="/layouts/pagination" model="${[linkUri: "actaprofesional/listarAlumnos", linkParams: [search: params.search?:"", institucionId: params.institucionId?:"", carreraId: params.carreraId?:"", cicloEscolarId: params.cicloEscolarId?:""], count: conteo, max: params.max, offset: params.offset]}"/>
