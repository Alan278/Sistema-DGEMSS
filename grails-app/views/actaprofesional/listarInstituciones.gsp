...
<html>
    ...
    <body>
        ...
        <div class="container">
            <form id='form-busqueda' action="/actaprofesional/listarInstituciones" class="mt-4">
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="input-group mb-3">
                            ...
                            <g:if test="${params.search}">
                                <div class="input-group-append">
                                    <g:link uri="/actaprofesional/listarInstituciones/" params="${[max: params.max, offset: params.offset]}" class="btn btn-outline-secondary">
                        ...
                        <g:each status="i" in="${instituciones}" var="institucion">
                            <tr>
                                ...
                                <td class="align-middle" align="end">
                                    <a onclick="mostrarProceso();" href="actaprofesional/listarActasInstitucion/${institucion.id}" class="alert-link">
                                        Ver constancias
                                    </a>
                                </td>
                            </tr>
        ...
        <g:render template="/layouts/pagination" model="${[linkUri: "actaprofesional/listarInstituciones", linkParams: [search: params.search?:"", isPublic: params.isPublic?:""], count: conteo, max: params.max, offset: params.offset]}"/>
