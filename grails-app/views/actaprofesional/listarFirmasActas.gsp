...
<html>
    ...
    <body>
        ...
        <g:render template="/layouts/pagination" model="${[linkUri: "actaprofesional/listarFirmasNotificaciones", linkParams: [search: params.search?:"", institucionId: params.institucionId?:""], count: conteo, max: params.max, offset: params.offset]}"/>
