    ...
    <body>
        ...
        <div class="container mt-3 mb-3">
            <div class="row align-items-end">
                ...
                <div class="col-md-4">
                    <p class="m-0"> <b> Fecha de expedición: </b> ${acta?.firmaAutenticadorDgemss?.fechaFirmaFormato}</p>
                </div>
            </div>
        </div>
        ...
        <div class="container mb-5">
            ...
            <g:else>
                <form id="formu" action="/actaprofesional/firmarActa" enctype="multipart/form-data" method="POST" class="needs-validation" novalidate>
                    <input type="text" name="uuid" value="${acta?.uuid}" hidden>
                    ...
                    <div class="form-row justify-content-end">
                        <p>
                            <a onclick="mostrarProceso();" href="actaprofesional/listarFirmasActas" class="btn btn-secondary">Cancelar</a>
