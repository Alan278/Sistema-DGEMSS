    ...
    <body>
        ...
        <content tag="buttons">
            <sec:ifAnyGranted roles='ROLE_GESTOR_ESCUELA'>
                <a href="/actaprofesional/consultarActasfecha" class="btn btn-primary col-md-12 my-2">
                    Nueva acta
                </a>
            </sec:ifAnyGranted>
        ...
        <div class="container">
            <form id="form-busqueda" action="/actaprofesional/consultarActasfecha" class="mt-4">
                    ...
                    <tBody>
                        <g:each in="${registros}" var="registro">
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        ${registro?.estatusActa?.nombre}
                                    </td>
                                    <td align="end">
                                        <% statusId = registro?.estatusActa?.id %>
                                        <g:if test="${statusId == 9}">
                                            <a onclick="mostrarProceso();" href="/actaprofesional/listarActasAlumno/${registro.alumno.id}" class="btn btn-outline-primary btn-sm" data-tooltip="tooltip" data-placement="top" title="Consultar Acta">
                                                <i class="bi bi-eye-fill"></i>
                                            </a>
                                        </g:if>
                                        <sec:ifAnyGranted roles='ROLE_GESTOR_ESCUELA'>
                                            <g:if test="${statusId == 1}">
                                                <a onclick="mostrarProceso();" href="/actaprofesional/subirFotoModificacion?uuid=${registro.uuid}" class="btn btn-outline-primary btn-sm" data-tooltip="tooltip" data-placement="top" title="Modificar logo">
                                                    <i class="fa fa-pencil"></i>
                                                </a>
                                            </g:if>
                                            <g:if test="${statusId == 1 || statusId == 9 || statusId == 6}">
                                                <a onclick="mostrarProceso();" href="/actaprofesional/consultar?uuid=${registro.uuid}" class="btn btn-outline-primary btn-sm" data-tooltip="tooltip" data-placement="top" title="Validar">
                                                    <i class="bi bi-check-lg"></i>
                                                </a>
                                            </g:if>
                                            <g:if test="${statusId == 1}">
                                                <button type="button" class="btn btn-outline-danger btn-sm" data-id="${registro.id}" data-toggle="modal" data-target="#modalEliminacion_${registro.id}" data-tooltip="tooltip" data-placement="top" title="Eliminar Registro">
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <a onclick="mostrarProceso();"  href="/actaprofesional/eliminar?uuid=${registro.uuid}" class="btn btn-primary">Aceptar</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
