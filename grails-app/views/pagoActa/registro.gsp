        ...
        <div class="container mb-5">
            ...
            <div class="tab-content mt-4" id="myTabContent">
                <div class="tab-pane fade ${!params.serie ? 'show active' : ''}" id="line-captura" role="tabpanel" aria-labelledby="home-tab">
                    <form id="lineCapturaForm" action="/pagoActa/registro" class="needs-validation" method="post" novalidate>
                        <div class="form-row">
                ...
                <div class="tab-pane fade  ${params.serie ? 'show active' : ''}" id="folio" role="tabpanel" aria-labelledby="profile-tab">
                    <form id="folioForm" action="/pagoActa/registro" class="needs-validation" method="post" novalidate>
                        <div class="form-row">
                            <div class="form-group col-md-5">
            ...
            <form action="/pagoActa/seleccionActas" class="needs-validation" novalidate>
